...
Route::prefix('settings')->group(function () {
    ...
    Route::middleware(['permission:payment-method,payment-method'])->group(function () {
        ...
        Route::get('payment/fedapay', [App\Http\Controllers\SettingsController::class, 'fedapay'])->name('payment.fedapay');
...
Route::middleware(['permission:admins,admin.users.store'])->group(function () {
    ...
    Route::post('admin-support-users/store', [App\Http\Controllers\UserController::class, 'storeAdminSupportUsers'])->name('admin.support.user.store');
});
