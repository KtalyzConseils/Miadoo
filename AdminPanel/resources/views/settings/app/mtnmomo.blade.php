        ...
        <div class="card">
            <div class="payment-top-tab mt-3 mb-3">
                <ul class="nav nav-tabs card-header-tabs align-items-end">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active mtnmomo_active_label"
            ...
            <div class="card-body">
                <div class="row restaurant_payout_create">
                    <div class="restaurant_payout_create-inner">
                        <fieldset>
                            <legend>{{trans('lang.app_setting_mtnmomo')}}</legend>
                            <div class="form-check width-100">
                                <input type="checkbox" class=" enable_mtnmomo" id="enable_mtnmomo">
                                <label class="col-3 control-label"
                                       for="enable_mtnmomo">{{trans('lang.app_setting_enable_mtnmomo')}}</label>
                            </div>
                            <div class="form-check width-100">
                            ...
                            <div class="form-group row width-100">
                                <label class="col-3 control-label">{{trans('lang.app_setting_mtnmomo_merchantKey')}}</label>
                                <div class="col-7">
                                    <input type="password" class="form-control mtnmomo_merchantKey">
                                    <div class="form-text text-muted">
                                        {!! trans('lang.app_setting_mtnmomo_merchantKey_help') !!}
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row width-100">
                                <label class="col-3 control-label">{{trans('lang.app_setting_mtnmomo_auth')}}</label>
                                <div class="col-7">
                                    <input type="password" class="form-control mtnmomo_auth">
                                    <div class="form-text text-muted">
                                        {!! trans('lang.app_setting_mtnmomo_auth_help') !!}
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row width-100">
                                <label class="col-3 control-label">{{trans('lang.app_setting_mtnmomo_clientid')}}</label>
                                <div class="col-7">
                                    <input type="password" class="form-control mtnmomo_clientId">
                                    <div class="form-text text-muted">
                                        {!! trans('lang.app_setting_mtnmomo_clientid_help') !!}
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row width-100">
                                <label class="col-3 control-label">{{trans('lang.app_setting_mtnmomo_secret')}}</label>
                                <div class="col-7">
                                    <input type="password" class=" form-control mtnmomo_secret">
                                    <div class="form-text text-muted">
                                        {!! trans('lang.app_setting_mtnmomo_secret_help') !!}
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row width-100">
                                <label class="col-3 control-label">{{trans('lang.app_setting_mtnmomo_cancelurl')}}</label>
                                <div class="col-7">
                                    <input type="text" class=" form-control mtnmomo_cancelUrl">
                                    <div class="form-text text-muted">
                                        {!! trans('lang.app_setting_mtnmomo_cancelurl_help') !!}
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row width-100">
                                <label class="col-3 control-label">{{trans('lang.app_setting_mtnmomo_notifyurl')}}</label>
                                <div class="col-7">
                                    <input type="text" class=" form-control mtnmomo_notifyUrl">
                                    <div class="form-text text-muted">
                                        {!! trans('lang.app_setting_mtnmomo_notifyurl_help') !!}
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row width-100">
                                <label class="col-3 control-label">{{trans('lang.app_setting_mtnmomo_returnurl')}}</label>
                                <div class="col-7">
                                    <input type="text" class=" form-control mtnmomo_returnUrl">
                                    <div class="form-text text-muted">
                                        {!! trans('lang.app_setting_mtnmomo_returnurl_help') !!}
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row width-100">
